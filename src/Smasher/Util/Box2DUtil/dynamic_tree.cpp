...
#include "Smasher/Util/Box2DUtil/aabb.h"
#include "Smasher/Util/Box2DUtil/constants.h"
#include "Smasher/Util/Box2DUtil/core.h"
...
int b2DynamicTree_Rebuild(b2DynamicTree* tree, bool fullBuild)
{
	...
	if (proxyCount > tree->rebuildCapacity)
	{
		...
		/* Modified Line */
		tree->leafIndices = (int*)b2Alloc(newCapacity * sizeof(int));
